...
"""
            ...
            <head>
                ...
                <style>
                    ...
                    .weather-item {{ 
                        background: #f8f9fa; padding: 15px; border-radius: 6px; text-align: center;
                    }}
                    .weather-value {{ font-size: 24px; font-weight: bold; color: #2c3e50; }}
                    .weather-label {{ font-size: 12px; color: #666; text-transform: uppercase; }}
                    .rainfall-section {{ 
