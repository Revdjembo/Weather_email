...
<body>
  <div class="container">
    ...
    <div class="section">
      ...
      {"<img src='cid:windrose' alt='Windrose' style='width:400px;height:auto;border:1px solid #eee;border-radius:8px;' />" if windrose_file else "<div style='color:#999;'>Wind data unavailable</div>"}
